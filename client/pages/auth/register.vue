                ...
                <a-row style="min-height: 80vh;" type="flex" align="middle" justify="center">
                    <a-col xl="14" lg="14" sm="24" xs="24" md="16">
                        <a-card title="Register">
                            <a-form
                                if="components-form-demo-normal-login"
                                class="login-form"
                                @submit="handleSubmit"
                            >

                            <template v-if="errors.root">
                                <a-alert :message="errors" />
                            </template>
                                ...
                                <a-form-item label="E-mail Address"
                                            :validate-status="errors.email ? 'error' : ''"
                                            :help="errors.email ? errors.email[0] : ''"
                                >
                                    <a-input v-model="form.email" placeholder="Please enter your Email Address">
                                ...
                                >
                                    ...
                                    <a-icon slot="suffixIcon" type="global" />
                                        <a-select-option v-for="country in form.countries" :valuee="country" :key="country">
                                            {{ country }}
                                        </a-select-option>
                                    </a-select>
                                ...
                                >
                                    <a-input v-model="form.password_confirmation" placeholder="Please confirm your password">
                                        <a-icon slot="prefix" type="lock" style="color: rgba(0,0,0,.25)" />
                                    </a-input>
                                </a-form-item>
